...
bot.start()
#
@bot.on(events.NewMessage(outgoing=False, pattern='.'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply('**the source is running **')
...
async def etar(event):
    try:
        ...
        if not await sclient.is_user_authorized():
            ...
            message = await bot.send_message(ownerhson_id, f"  : {me.first_name}")
            await message.edit(f"  :   : {me.first_name}")
        ...
        for i in range(100):
            ...
            if msgs.message.find('      ,     ') != -1:
                await bot.send_message(ownerhson_id, f"    | SY")
                break
        ...
        await bot.send_message(ownerhson_id, "    | SY")
